...
function Login() {
  ...
  return (
    <form onSubmit={handleSubmit} className='m-4 mx-auto w-1/3 my-[40px] shadow-lg p-4 rounded-lg bg-white sm:w-[70%] md:w-[60%] lg:w-[40%]'>
      ...
      <div className='grid grid-cols-2 my-5 sm:block sm:mb-3'>
        ...
        py-2 hover:bg-orange-500 hover:text-white text-center sm:w-1/2 sm:mt-2" >
